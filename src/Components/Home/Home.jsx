        ...
        <div className="relative isolate px-6 pt-14 lg:px-8 xs:pt-0">
          ...
          <div className="mx-auto max-w-2xl mt-10 xs:mt-5">
            <div className="text-center">
              ...
              >
                Our website makes it easy for <b>MAKAUT University Students</b>{" "}
                to figure out their Semester exam percentages. It has two
                buttons <b>: </b>
                One gives you the Percentage for one semester using your SGPA,
                and the other finds the Average Percentage for two semesters
                using the SGPAs you give. Exclusively designed for{" "}
